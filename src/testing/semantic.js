...
const DIMENSION_RULES = {
  freedom: {
    positive: [
      ['自由', 2.8], ['冲破', 2.4], ['束缚', 2.4], ['反抗', 2.2], ['真相', 1.4], ['出口', 1.4], ['意志', 1.6], ['执念', 1.6], ['逆转', 1.8], ['质疑规则', 2.2], ['刺头', 1.6], ['渴望', 1.6], ['夺走', 1.8], ['战斗', 1.3], ['不惜一切代价', 1.2], ['冲', 1.0],
    ],
    negative: [
  ...
  moral: {
    positive: [
      ['舍弃人性', 3.0], ['牺牲', 1.6], ['背负', 1.8], ['罪孽', 2.0], ['痛下杀手', 2.6], ['欺骗', 1.8], ['统治', 1.2], ['铲除', 1.6], ['残酷', 1.4], ['必要', 1.2], ['恶魔', 1.6], ['工具', 1.0], ['舍弃', 1.2],
    ],
    negative: [
      ['无法接受', 2.8], ['正义', 1.8], ['沟通', 1.4], ['保护', 1.0], ['爱', 1.0], ['共存', 1.0], ['真实', 1.0], ['幸福', 0.8],
    ],
  },
  realism: {
    positive: [
      ...
      ['务实', 2.2], ['士兵', 1.2], ['执行命令', 1.4], ['封印', 1.6], ['不配拥有', 1.4],
    ],
    negative: [
  ...
  fatalism: {
    positive: [
      ...
      ['梦想', 0.8], ['仇恨', 1.2], ['爱', 0.8], ['煎熬', 1.2], ['封印', 0.8],
    ],
    negative: [
...
const ARCHETYPE_RULES = [
  ...
  { tag: 'protector', keywords: ['保护', '爱的人', '守护', '围巾', '父亲', '重要的人'] },
  { tag: 'collective', keywords: ['同胞', '民族', '责任', '使命', '大义', '社会', '家园', '未来'] },
  ...
  { tag: 'soldier', keywords: ['士兵', '执行命令', '责任', '煎熬', '牺牲者'] },
];
