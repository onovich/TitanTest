...
const DIMENSION_RULES = {
  freedom: {
    positive: [
      ['自由', 2.8], ['冲破', 2.4], ['束缚', 2.4], ['反抗', 2.2], ['真相', 1.4], ['出口', 1.4], ['意志', 1.6], ['执念', 1.6], ['逆转', 1.8], ['质疑规则', 2.2], ['刺头', 1.6], ['渴望', 1.6], ['夺走', 1.8], ['战斗', 1.3], ['不惜一切代价', 1.2], ['冲', 1.0], ['选择', 1.2], ['被安排', 1.4], ['身份定义', 1.8], ['束缚现在', 1.6], ['保留意见', 1.4], ['保留判断', 1.4], ['回旋', 1.2], ['各自', 1.1], ['独处', 1.2], ['突破口', 1.8], ['打破现状', 1.8], ['主动权', 1.6], ['不退让', 1.4], ['冒险', 1.2],
    ],
    negative: [
  ...
  moral: {
    positive: [
      ['舍弃人性', 3.0], ['牺牲', 1.6], ['背负', 1.8], ['罪孽', 2.0], ['痛下杀手', 2.6], ['欺骗', 1.8], ['统治', 1.2], ['铲除', 1.6], ['残酷', 1.4], ['必要', 1.2], ['恶魔', 1.6], ['工具', 1.0], ['舍弃', 1.2], ['共同敌人', 2.2], ['忍痛放弃', 2.0], ['压倒性力量', 2.0], ['污名', 1.2], ['承担责任', 1.8], ['底线', 1.4], ['有限度', 1.2], ['体面', 1.1],
    ],
    negative: [
      ['无法接受', 2.8], ['正义', 1.8], ['沟通', 1.4], ['保护', 1.0], ['爱', 1.0], ['共存', 1.0], ['真实', 1.0], ['幸福', 0.8], ['孩子', 1.4], ['结束循环', 1.8], ['理解', 1.2], ['说服', 1.4], ['公开承担', 1.6], ['无辜者', 1.8],
    ],
  },
  realism: {
    positive: [
      ...
      ['务实', 2.2], ['士兵', 1.2], ['执行命令', 1.4], ['封印', 1.6], ['不配拥有', 1.4], ['留后手', 2.2], ['部分公开', 1.8], ['情报', 1.8], ['步骤', 1.6], ['复盘', 2.2], ['风险', 1.6], ['民心', 1.2], ['消化真相', 2.2], ['消化', 1.4], ['理解', 1.4], ['余地', 1.2], ['代价更低', 1.8], ['承受范围', 1.6], ['使用范围', 1.8], ['谈判筹码', 2.0], ['局面', 1.2], ['稳住', 1.2], ['公开方式', 1.6], ['更多人的安全', 1.8],
    ],
    negative: [
  ...
  cause: {
    positive: [
      ...
      ['士兵', 1.2], ['牺牲者', 1.2], ['同伴', 1.8], ['民心', 1.8], ['团结', 2.0], ['内部', 1.2], ['同行', 1.4], ['共同敌人', 1.8], ['留下理解与消化真相的余地', 2.4], ['同伴留下', 1.6], ['信任', 1.4], ['汇合', 1.2], ['彼此', 1.2], ['为何而战', 1.8], ['聊一聊', 1.2], ['更多人的安全', 1.6], ['维持秩序', 1.6], ['责任和未来', 2.0], ['规划方向', 1.6], ['后续局面', 1.4],
    ],
    negative: [
...
const ARCHETYPE_RULES = [
  ...
  { tag: 'truthseeker', keywords: ['真相', '真实', '无知', '追寻', '消化真相'] },
  ...
  { tag: 'mediator', keywords: ['谈判', '说服', '理解', '共同制定方案', '沟通', '消化真相', '余地'] },
];
