...
const DIMENSION_RULES = {
  ...
  realism: {
    positive: [
      ...
      ['务实', 2.2], ['士兵', 1.2], ['执行命令', 1.4], ['封印', 1.6], ['不配拥有', 1.4], ['留后手', 2.2], ['部分公开', 1.8], ['情报', 1.8], ['步骤', 1.6], ['复盘', 2.2], ['风险', 1.6], ['民心', 1.2], ['消化真相', 2.2], ['消化', 1.4], ['理解', 1.4], ['余地', 1.2],
    ],
    negative: [
  ...
  cause: {
    positive: [
      ...
      ['士兵', 1.2], ['牺牲者', 1.2], ['同伴', 1.8], ['民心', 1.8], ['团结', 2.0], ['内部', 1.2], ['同行', 1.4], ['共同敌人', 1.8], ['留下理解与消化真相的余地', 2.4], ['同伴留下', 1.6],
    ],
    negative: [
