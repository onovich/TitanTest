...
const BASE_CHARACTERS = [
  ...
  { name: '阿明·阿诺德', aliases: ['阿尔敏 阿诺德'], desc: '重视理解、沟通与策略推演，必要时接受为了改变局势而做出残酷取舍。', scores: { freedom: 7, moral: 6, realism: 8, fatalism: 5, cause: 9 }, quote: '什么都无法舍弃的人，什么也改变不了。' },
  ...
  { name: '利威尔·阿克曼', aliases: ['利威尔 阿克曼'], desc: '高执行力的前线指挥者，重视判断、结果和对战友承诺的兑现。', scores: { freedom: 4, moral: 5, realism: 8, fatalism: 7, cause: 6 }, quote: '选择吧，是相信自己，还是相信同伴……我不知道正确答案。你只能选择到时候不会后悔的做法。' },
  ...
  { name: '让·基尔希斯坦', aliases: ['让 基尔希斯坦'], desc: '从自保倾向明显的普通士兵成长为能承担责任的前线骨干。', scores: { freedom: 6, moral: 4, realism: 8, fatalism: 3, cause: 7 }, quote: '如果我闭上耳朵、躲在房间里不出来……死者的骨灰绝不会原谅我。' },
  { name: '格里沙·耶格尔', aliases: ['格里沙 耶格尔'], desc: '被时代、家族与使命连续推动的人，长期在责任、亲情与悔恨中行动。', scores: { freedom: 5, moral: 7, realism: 4, fatalism: 9, cause: 7 }, quote: '如果早知道自由的代价是这样，我绝不会付出。' },
